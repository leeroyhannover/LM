...
history = model.fit_generator(my_generator, validation_data=validation_datagen, steps_per_epoch=50, validation_steps=50, epochs=150, callbacks = callbacks)
...
model.save("./Unet/model/Unet2D_transfer_resnet_150.h5")
